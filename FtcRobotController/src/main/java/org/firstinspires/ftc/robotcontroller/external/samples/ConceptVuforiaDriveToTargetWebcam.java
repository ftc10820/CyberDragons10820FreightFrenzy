...
/**
 * This OpMode illustrates using a webcam to locate and org.firstinspires.ftc.teamcode.RoadRunner.drive towards ANY Vuforia target.
 * The code assumes a basic two-wheel Robot Configuration with motors named left_drive and right_drive.
 * The motor directions must be set so a positive org.firstinspires.ftc.teamcode.RoadRunner.drive goes forward and a positive turn rotates to the right.
 *
 * Under manual control, the left stick will move forward/back, and the right stick will turn left/right.
 * This is called POV Joystick mode, different than Tank Drive (where each joystick controls a wheel).
 * Manually org.firstinspires.ftc.teamcode.RoadRunner.drive the robot until it displays Target data on the Driver Station.
...
public class ConceptVuforiaDriveToTargetWebcam extends LinearOpMode
{
    ...
    final double DESIRED_DISTANCE = 8.0; //  this is how close the camera should get to the target (inches)
                                         ...
                                         //  and how much power is applied to the org.firstinspires.ftc.teamcode.RoadRunner.drive motors.  Drive = Error * Gain
    ...
    @Override public void runOpMode()
    {
        ...
        // To org.firstinspires.ftc.teamcode.RoadRunner.drive forward, most robots need the motor on one side to be reversed, because the axles point in opposite directions.
        // Pushing the left stick forward MUST make robot go forward. So adjust these two lines based on your first test org.firstinspires.ftc.teamcode.RoadRunner.drive.
        ...
        while (opModeIsActive())
        {
            ...
            if (gamepad1.left_bumper && targetFound) {
                ...
                // org.firstinspires.ftc.teamcode.RoadRunner.drive using manual POV Joystick mode.
                drive = -gamepad1.left_stick_y  / 2.0;  // Reduce org.firstinspires.ftc.teamcode.RoadRunner.drive rate to 50%.
